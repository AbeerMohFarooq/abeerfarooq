...
🎯 A Senior Android & Flutter Developer with 5+ years of experience delivering secure, scalable, and high-performance mobile apps.
📍 Based in Kuwait | 🌐 Open to remote & on-site opportunities

## 🛠 Skills
- 🧱 Clean Architecture, MVVM
- 📱 Kotlin, Java, Dart, Jetpack Compose, Flutter
- ☁️ Firebase, RESTful APIs, Room, Hive
- 🔐 Implementing secure APIs with Retrofit and SSL pinning.
- 🧪 TDD with JUnit
...
**UI**: Jetpack Compose, XML, Flutter  
**State Management**: StateFlow, LiveData, GetX, Riverpod, BLoC  
**Storage**: Room, DataStore, Hive, SharedPreferences  
**Networking**: Retrofit, OkHttp, FCM, WebSocket  
**Testing**: JUnit  
**DevOps**: Git, GitHub, Azure Pipelines
